...
from Snowflake.utils import PointNet_SA_Module_KNN, MLP_Res, MLP_CONV, fps_subsample, Transformer
from Snowflake.skip_transformer import SkipTransformer
...
if __name__ == "__main__":
    ...
    ae = SnowflakeNet(up_factors=[4, 8]).cuda()
    # ae_decoder = ASFMDecoder().cuda()

    arr_pcd = ae(pcs)

    print("1:", arr_pcd[0].size())
    print("2:", arr_pcd[1].size())
    print("3:", arr_pcd[2].size())
    print("4:", arr_pcd[3].size())
