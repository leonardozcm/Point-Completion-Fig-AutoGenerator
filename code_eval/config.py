...
__C.DATASETS.COMPLETION3D.PARTIAL_POINTS_PATH    = '../dataset/Completion3D/%s/partial/%s/%s.h5'
__C.DATASETS.COMPLETION3D.COMPLETE_POINTS_PATH   = '../dataset/Completion3D/%s/gt/%s/%s.h5'
...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '../dataset/ShapeNetCompletion/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '../dataset/ShapeNetCompletion/%s/complete/%s/%s.pcd'
__C.DATASETS.KITTI                               = edict()
__C.DATASETS.KITTI.CATEGORY_FILE_PATH            = './datasets/KITTI.json'
__C.DATASETS.KITTI.PARTIAL_POINTS_PATH           = '../dataset/KITTI/cars/%s.pcd'
__C.DATASETS.KITTI.BOUNDING_BOX_FILE_PATH        = '../dataset/KITTI/bboxes/%s.txt'
...
__C.NETWORK.GRIDDING_LOSS_SCALES                 = [128] # 128
...
__C.TRAIN.LR_MILESTONES                          = [50, 100, 150]
__C.TRAIN.GAMMA                                  = .1 # 0.5 for weight decay
