...
__C.DATASETS.COMPLETION3D.PARTIAL_POINTS_PATH = '/home/chriskafka/dataset/Completion3D/%s/partial/%s/%s.h5'
__C.DATASETS.COMPLETION3D.COMPLETE_POINTS_PATH = '/home/chriskafka/dataset/Completion3D/%s/gt/%s/%s.h5'
...
__C.CONST.FTWEIGHTS = 'checkpoint/ckpt-epoch-221.pth'
...
__C.TRAIN.FINETUNE_BATCH_SIZE = 8


__C.TRAIN.N_EPOCHS = 800
__C.TRAIN.SAVE_FREQ = 1
__C.TRAIN.LEARNING_RATE = 0.001
__C.TRAIN.BACKBONE_LEARNING_RATE = 0.000005
