...
from PMPNet.utils import Conv1d, PointNet_FP_Module, PointNet_SA_Module
...
class StepModel(nn.Module):
    def __init__(self, step=1):
        ...
        self.step = step
        # if step == 1:
        #     self.sa_module_1 = PointNet_SA_Module(512, 32, 0.2, 6, [64, 64, 128], group_all=False)
        ...
        #     self.fp_module_1 = PointNet_FP_Module(128, [128, 128, 128], use_points1=True, in_channel_points1=9)
        # else:
...
class Model(nn.Module):
    ...
    def forward(self, point_cloud):
        ...
        return pcd_out_1.permute(0, 2, 1).contiguous()
...
if __name__ == "__main__":
    ...
    print("4:", arr_pcd.size())

    # checkpoint = torch.load("checkpoint/snowflakenet.pth")
