...
from SiaTrans.utils import Conv2d
...
class PointConvDensitySetAbstraction(nn.Module):
    def __init__(self, npoint, nsample, in_channel, mlp, bandwidth=0.1, use_xyz=True, group_all=False, if_bn=True, **kwags):
        ...
        for out_channel in mlp:
            self.mlp_conv.append(
                Conv2d(last_channel, out_channel, if_bn=if_bn))
